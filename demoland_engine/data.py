...
files = {
    ...
    "isle_of_wight": {
        ...
        "urls": {
            ...
            "iqr_function": f"{BASE_URL}/main/data/global/iqr_function.parquet",
            # locally specific files
            "accessibility": f"{BASE_URL}/main/data/isle_of_wight/accessibility.joblib",
            "matrix": f"{BASE_URL}/main/data/isle_of_wight/matrix.parquet",
            "default_data": f"{BASE_URL}/main/data/isle_of_wight/default_data.parquet",
            "empty": f"{BASE_URL}/main/data/isle_of_wight/empty.parquet",
            "oa_area": f"{BASE_URL}/main/data/isle_of_wight/oa_area.parquet",
            "oa_key": f"{BASE_URL}/main/data/isle_of_wight/oa_key.parquet",
        },
    },
}
